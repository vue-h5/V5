// 城市信息：https://github.com/dwqs/area-data/blob/master/pcaa.js
export default [
    {
        label: '北京', 
        value: '北京', 
    ...
    { 
        ...
        children: [
            ...
            { label: '克拉玛依', value: '克拉玛依', disabled: true },
            { label: '吐鲁番地区', value: '吐鲁番地区', disabled: true },
            { label: '哈密地区', value: '哈密地区', disabled: true },
